    ...
    <div class="card-body">
        <form action="{{ route('pinalti.updatePralomba') }}" method="post">
            ...
            <div class="input-group">
                ...
                <input name="pinalti_umum" type="number" class="form-control" value="{{ $pinalti->umum->value }}">
                <div class="input-group-prepend">
                    <span class="input-group-text">Persentase Utama</span>
                </div>
                <input name="pinalti_utama" type="number" class="form-control" value="{{ $pinalti->utama->value }}">
